...
public class ThumbnailCache {
    private final java.util.Map<String, javafx.scene.image.Image> strongCache = new java.util.LinkedHashMap<String, javafx.scene.image.Image>(16,0.75f,true) {
    ...
    private final java.util.Map<String, java.lang.ref.SoftReference<javafx.scene.image.Image>> softCache = new java.util.HashMap<>();
